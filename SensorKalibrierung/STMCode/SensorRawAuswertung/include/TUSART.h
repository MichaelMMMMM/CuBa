...
private:
	volatile UInt32* sUSART_SR 		= reinterpret_cast<UInt32*>(baseAddr + 0x00U);
	volatile UInt32* sUSART_DR 		= reinterpret_cast<UInt32*>(baseAddr + 0x04U);
	volatile UInt32* sUSART_BRR 	= reinterpret_cast<UInt32*>(baseAddr + 0x08U);
	volatile UInt32* sUSART_CR1 	= reinterpret_cast<UInt32*>(baseAddr + 0x0CU);
	volatile UInt32* sUSART_CR2 	= reinterpret_cast<UInt32*>(baseAddr + 0x10U);
	volatile UInt32* sUSART_CR3 	= reinterpret_cast<UInt32*>(baseAddr + 0x14U);
	volatile UInt32* sUSART_GTPR 	= reinterpret_cast<UInt32*>(baseAddr + 0x18U);
};
